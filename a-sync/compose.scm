...
;; await-put-bytevector!, await-put-string!, await-accept!,
;; await-connect!, await-task-in-thread-pool! and
;; await-generator-in-thread-pool! procedures provided by the (a-sync
;; event-loop), (a-sync sockets) and (a-sync thread-pool) modules are
...
;; await-glib-timeout, await-glib-getline, await-glib-getblock,
;; await-glib-put-bytevector and await-glib-put-string procedures in
;; the (a-sync gnome-glib) module.
;;
