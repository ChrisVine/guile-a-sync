...
;; and await-put-string! convenience procedures, the sockets module
;; has await-accept! and await-connect! procedures, and the
;; thread-pool module has await-task-in-thread-pool! and
